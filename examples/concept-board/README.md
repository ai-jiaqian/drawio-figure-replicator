...
| Model Pipeline | [model-pipeline.drawio](model-pipeline/model-pipeline.drawio) | [model-pipeline.png](model-pipeline/model-pipeline.png) | [SVG_ASSETS.md](model-pipeline/SVG_ASSETS.md) |
